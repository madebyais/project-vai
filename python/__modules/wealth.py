class Wealth:
    ...
    def __init__(self, db):
        self.db = db
        self.QUERY_ALL = "SELECT year, wealth_top_10, wealth_bottom_50 FROM tbl_data WHERE year >= %s and year <= %s"
        self.QUERY_TOP_10 = "SELECT year, wealth_top_10 FROM tbl_data WHERE year >= %s and year <= %s"
        self.QUERY_BOTTOM_50 = "SELECT year, wealth_bottom_50 FROM tbl_data WHERE year >= %s and year <= %s"
